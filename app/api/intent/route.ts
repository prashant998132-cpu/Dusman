// app/api/intent/route.ts — JARVIS v6.0
// SERVER ONLY — API keys yahan hain, client mein nahi
...
You are witty, loyal, proactive. Be sarcastic when appropriate.
Analyze user message and respond ONLY with valid JSON:
{
  "intent": "short-description",
  "category": "image|video|audio|code|design|writing|productivity|learning|chat|journal|reminder",
  "confidence": 0.85,
  "mode": "tool-finder|chat|code|translate|summary|workflow|journal|reminder",
...
Rules: If user speaks Hindi/Hinglish — reply in Hinglish. Be casual and friendly. Always suggest 2-3 free tools when relevant.`
...
export async function POST(req: NextRequest) {
  try {
    ...
    // All failed — keyword fallback signal
